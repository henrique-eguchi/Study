...
/// Question: What is a closure in Swift, and how is it different from a function?

/// Question: How can closures be used for filtering elements in an array, as demonstrated in the provided code?

/// Question: Explain the concept of trailing closure syntax in Swift. Provide an example from the code.

/// Question: What does the @escaping attribute mean in the context of closures, and when would you use it?

/// Question: Compare and contrast the topStudentFilter closure and the topStudentFilterFunc function in terms of usage and syntax.

/// Question: In the context of the provided code, why might you choose to use a closure for filtering instead of a traditional function?

/// Question: How does the closure syntax { $0.testScore > 80 } work, and what is its equivalent long-form syntax?

/// Question: Describe a scenario where you might use a closure with the sorted function, as demonstrated in the code.

// MARK: - Answers

/// Answer: A closure in Swift is a self-contained block of functionality that can be passed around and used in your code.
...
/// Answer: Closures can be used as predicates for filtering elements in an array using functions like filter. In the code,
/// the topStudentFilter closure is used to filter students with a test score greater than 80.

/// Answer: Trailing closure syntax is a feature in Swift where if a closure is the last argument of a function, it can be
/// placed outside the parentheses. This enhances code readability. In the code, the filter and sorted functions use
/// trailing closure syntax.

/// Answer: The @escaping attribute is used to indicate that a closure passed as a parameter to a function will be stored
...
/// Answer: Both topStudentFilter and topStudentFilterFunc serve the same purpose of filtering top students. However,
...
/// Answer: Using a closure for filtering can be more concise and expressive, especially for short-lived operations.
/// It promotes cleaner code and is often preferred for simple tasks like filtering an array.

/// Answer: The closure syntax { $0.testScore > 80 } is a shorthand way of writing closures in Swift. It represents a
...
/// Answer: You might use a closure with the sorted function when you want to customize the sorting order based on a
